...
class LearnTypesMinMax {
    public static void main(String[] args) {
        ...
        answer.isMinimumFloat(0x0.000002p-126f);
        answer.isMaximumFloat(0x1.fffffep127f);

        // Find the double min/max in docs, navigate from the Float page
        answer.isMinimumDouble(0x0.0000000000001p-1022);
        answer.isMaximumDouble(0x1.fffffffffffffp1023);
